...
//	// 通过编码器获取车轮实时转速m/s
	...
	ENCODER_D_SetCounter(0);
		...
		// 通过编码器获取车轮实时转速m/s
//	Wheel_A.RT = (float)-((int16_t)Calculate_Motor_A_RPM() * 0.08 * PI / 60.0);
//	ENCODER_A_SetCounter(0);
//	Wheel_B.RT = (float)((int16_t)Calculate_Motor_B_RPM() * 0.08 * PI / 60.0);
//	ENCODER_B_SetCounter(0);
//	Wheel_C.RT = (float)-((int16_t)Calculate_Motor_C_RPM() * 0.08 * PI / 60.0);
//	ENCODER_C_SetCounter(0);
//	Wheel_D.RT = (float)((int16_t)Calculate_Motor_D_RPM() * 0.08 * PI / 60.0);
//	ENCODER_D_SetCounter(0);
...
//		if(z_angle > 5)
//		{
//			Wheel_A.PWM += z_angle * 66.6;
//			Wheel_C.PWM += z_angle * 66.6;
//			Wheel_B.PWM -= z_angle * 66.6;
//			Wheel_D.PWM -= z_angle * 66.6;
//		}
//		else if(z_angle < -5)
//		{
//			Wheel_A.PWM -= z_angle * 66.6;
